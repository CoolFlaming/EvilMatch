-- ============================================================================
-- EVILMATCH SAMPLE DATA - WITH frst_ PREFIX
...
INSERT INTO frst_villains (alias, real_name, evil_level, preferred_partner_type, bio, nemesis) VALUES
...
INSERT INTO frst_lairs (villain_id, location_name, security_level, has_lava_moat, has_shark_tank, square_footage) VALUES
...
INSERT INTO frst_evil_plans (villain_id, plan_name, estimated_completion_year, status, budget_in_millions, difficulty_rating) VALUES
...
INSERT INTO frst_matches (villain_id_1, villain_id_2, match_status, compatibility_score, first_date_location) VALUES
