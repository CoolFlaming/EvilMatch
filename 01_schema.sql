...
-- ============================================================================
-- TABLE 2: Lairs (One-to-Many with Villains)
-- ============================================================================
...
-- ============================================================================
-- TABLE 3: Evil_Plans (One-to-Many with Villains)
-- ============================================================================

CREATE TABLE Evil_Plans (
...
-- ============================================================================
-- TABLE 4: Matches (Many-to-Many Self-Referencing)
-- ============================================================================
...
CREATE TABLE Matches (
    ...
    FOREIGN KEY (villain_id_1) REFERENCES Villains(villain_id)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    FOREIGN KEY (villain_id_2) REFERENCES Villains(villain_id)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
